  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-[95vh] min-h-[600px] max-h-[1200px] overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 lg:gap-12 items-center h-full py-8 sm:py-12 lg:py-16">
              <div className="lg:col-span-7 text-center lg:text-left order-2 lg:order-1">
                <div className="space-y-4 sm:space-y-6 lg:space-y-8">
                  <div className="space-y-3 sm:space-y-4 lg:space-y-6">
                    {/* Animated Brand Line */}
                    <div
                      className={`flex items-center justify-center lg:justify-start space-x-3 transition-all duration-700 ${isAnimating ? "opacity-0 translate-y-4" : "opacity-100 translate-y-0"
                        }`}
                      style={{ transitionDelay: isAnimating ? "0ms" : "200ms" }}
                    >
                      <div
                        className={`w-6 sm:w-8 lg:w-12 h-0.5 transition-colors duration-500 ${currentSlideData.accent === "green"
                          ? "bg-green-500"
                    ...
                    <div className="space-y-1 sm:space-y-2">
                      <div
                        className={`transition-all duration-700 ${isAnimating ? "opacity-0 translate-x-8 scale-95" : "opacity-100 translate-x-0 scale-100"
                          }`}
                    ...
                    <div className="space-y-1 sm:space-y-2">
                      <div
                        className={`transition-all duration-700 ${isAnimating ? "opacity-0 translate-y-8" : "opacity-100 translate-y-0"
                          }`}
                        style={{ transitionDelay: isAnimating ? "0ms" : "800ms" }}
                      >
                        <div
                          className={`text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-black tracking-tighter leading-none transition-colors duration-500 ${currentSlideData.accent === "green"
                            ? "text-green-400"
                            : currentSlideData.accent === "red"
                              ? "text-red-400"
                              : "text-yellow-400"
                    ...
                    <div
                      className={`max-w-lg mx-auto lg:mx-0 transition-all duration-700 ${isAnimating ? "opacity-0 translate-y-4" : "opacity-100 translate-y-0"
                        }`}
                  ...
                  {/* Animated Buttons */}
                  <div
                    className={`flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center lg:justify-start transition-all duration-700 ${isAnimating ? "opacity-0 translate-y-4" : "opacity-100 translate-y-0"
                      }`}
                  ...
                  <div
                    className={`pt-2 sm:pt-4 lg:pt-8 transition-all duration-700 ${isAnimating ? "opacity-0 translate-y-4" : "opacity-100 translate-y-0"
                      }`}
                      ...
                      <div className="flex justify-center space-x-3 sm:space-x-4">
                        {heroSlides.map((_, index) => (
                          ...
                          >
                            {/* Base dot */}
                            <div
                              className={`w-full h-full rounded-full transition-all duration-300 ${index === currentSlide ? "bg-white" : "bg-white/40 hover:bg-white/60"
                                }`}
                            ></div>
                              ...
                              <div className="absolute inset-0 -m-0.5 sm:-m-1">
                                <svg className="w-4 h-4 sm:w-6 sm:h-6 transform -rotate-90" viewBox="0 0 24 24">
                                  ...
                                  <circle
                                    ...
                                    className={`transition-all duration-100 ease-linear ${currentSlideData.accent === "green"
                                      ? "text-green-400"
                                      : currentSlideData.accent === "red"
                                        ? "text-red-400"
                                        : "text-yellow-400"
              ...
              <div className="lg:col-span-5 order-1 lg:order-2">
                <div
                  className={`relative max-w-xs sm:max-w-sm md:max-w-md mx-auto lg:max-w-none transition-all duration-1000 ${isAnimating ? "opacity-0 scale-75 rotate-12" : "opacity-100 scale-100 rotate-0"
                    }`}
                  style={{ transitionDelay: isAnimating ? "0ms" : "800ms" }}
                >
                  <div className="aspect-square bg-white/10 backdrop-blur-sm rounded-sm relative overflow-hidden border border-white/20">
                    <div className="absolute inset-0 flex items-center justify-center">
                      <div className="text-center space-y-3 sm:space-y-4">
                        <div
                          className={`w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 rounded-full mx-auto flex items-center justify-center backdrop-blur-sm transition-colors duration-500 ${currentSlideData.accent === "green"
                            ? "bg-green-500/90"
                            : currentSlideData.accent === "red"
                              ? "bg-red-500/90"
                              : "bg-yellow-400/90"
                    ...
                    <div
                      className={`absolute top-3 sm:top-4 md:top-6 lg:top-8 right-3 sm:right-4 md:right-6 lg:right-8 w-2 sm:w-3 md:w-4 h-2 sm:h-3 md:h-4 rounded-full transition-colors duration-500 ${currentSlideData.accent === "green"
                        ? "bg-green-400"
                        : currentSlideData.accent === "red"
                          ? "bg-red-400"
                          : "bg-yellow-300"
                  ...
                  {/* Floating elements */}
                  <div
                    className={`absolute -top-1 sm:-top-2 md:-top-3 lg:-top-4 -left-1 sm:-left-2 md:-left-3 lg:-left-4 w-4 sm:w-5 md:w-6 lg:w-8 h-4 sm:h-5 md:h-6 lg:h-8 border-2 rounded-full transition-colors duration-500 ${currentSlideData.accent === "green"
                      ? "border-green-400"
                      : currentSlideData.accent === "red"
                        ? "border-red-400"
                        : "border-yellow-300"
        ...
        <div
          className={`absolute top-8 sm:top-12 md:top-16 lg:top-32 left-0 w-0.5 sm:w-0.5 md:w-1 h-8 sm:h-12 md:h-16 lg:h-32 transition-colors duration-500 ${currentSlideData.accent === "green"
            ? "bg-green-500/40"
            : currentSlideData.accent === "red"
              ? "bg-red-500/40"
              : "bg-yellow-400/40"
      ...
      <section id="philosophy" ref={philosophyRef} className="py-12 sm:py-24 bg-white relative overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none">
          <div
            className={`absolute top-20 left-10 w-32 h-32 bg-green-500/5 rounded-full transition-all duration-1000 ${isPhilosophyVisible ? "opacity-100 scale-100" : "opacity-0 scale-50"
              }`}
          ></div>
          <div
            className={`absolute bottom-20 right-10 w-24 h-24 bg-yellow-400/5 rounded-full transition-all duration-1000 delay-300 ${isPhilosophyVisible ? "opacity-100 scale-100" : "opacity-0 scale-50"
              }`}
          ></div>
          <div
            className={`absolute top-1/2 left-1/4 w-16 h-16 bg-red-500/5 rounded-full transition-all duration-1000 delay-500 ${isPhilosophyVisible ? "opacity-100 scale-100" : "opacity-0 scale-50"
              }`}
          ></div>

          {/* Floating Mascots */}
          <div
            className={`absolute top-32 right-20 w-12 h-12 transition-all duration-1000 delay-700 ${isPhilosophyVisible ? "opacity-20 scale-100 rotate-12" : "opacity-0 scale-50 rotate-0"
              }`}
          >
            <img src="/images/mascot-1.png" alt="CTZNS Mascot" className="w-full h-full object-contain" />
          </div>
          <div
            className={`absolute bottom-32 left-32 w-14 h-14 transition-all duration-1000 delay-900 ${isPhilosophyVisible ? "opacity-15 scale-100 -rotate-12" : "opacity-0 scale-50 rotate-0"
              }`}
          >
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-start">
            <div className="space-y-6 sm:space-y-8">
              <div className="space-y-4 sm:space-y-6 text-center lg:text-left">
                <div
                  className={`flex items-center justify-center lg:justify-start space-x-3 transition-all duration-700 ${isPhilosophyVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
                    }`}
                >
                ...
                <div
                  className={`transition-all duration-700 delay-200 ${isPhilosophyVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
                    }`}
                >
                  <h2 className="text-3xl sm:text-4xl md:text-5xl font-black tracking-tighter text-black">
                    ...
                    <span className="block text-green-500 relative">
                      ...
                      {/* Animated underline */}
                      <div
                        className={`absolute bottom-0 left-0 h-1 bg-green-500/20 transition-all duration-1000 delay-700 ${isPhilosophyVisible ? "w-full" : "w-0"
                          }`}
                      ></div>
                    </span>
                  </h2>
                ...
                <div
                  className={`w-16 h-1 bg-green-500 mx-auto lg:mx-0 mt-4 transition-all duration-1000 delay-700 ${isPhilosophyVisible ? "opacity-100 scale-100" : "opacity-0 scale-50"
                    }`}
                ></div>
              </div>

              <div
                className={`space-y-4 sm:space-y-6 text-base sm:text-lg font-light text-gray-700 leading-relaxed transition-all duration-700 delay-400 ${isPhilosophyVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
                  }`}
              >
                <p>
              ...
              <div
                className={`grid grid-cols-1 sm:grid-cols-2 gap-6 pt-4 sm:pt-8 transition-all duration-700 delay-600 ${isPhilosophyVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
                  }`}
              >
            ...
            <div className="space-y-6 sm:space-y-8 mt-8 lg:mt-0">
              ...
              <div
                className={`bg-gray-50/50 p-6 sm:p-8 border-l-4 border-green-500 relative overflow-hidden transition-all duration-700 delay-300 ${isPhilosophyVisible ? "opacity-100 translate-x-0" : "opacity-0 translate-x-8"
                  }`}
              >
                {/* Animated background accent */}
                <div
                  className={`absolute top-0 right-0 w-16 h-16 bg-green-500/5 rounded-full transition-all duration-1000 delay-800 ${isPhilosophyVisible ? "opacity-100 scale-100" : "opacity-0 scale-0"
                    }`}
                ></div>
              ...
              <div
                className={`grid grid-cols-3 gap-4 sm:gap-6 transition-all duration-700 delay-500 ${isPhilosophyVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
                  }`}
              >
                <div className="text-center space-y-2 group">
                  <div
                    className={`text-2xl sm:text-3xl font-black text-black transition-all duration-500 delay-700 ${isPhilosophyVisible ? "opacity-100 scale-100" : "opacity-0 scale-50"
                  ...
                  <div className="w-full h-1 bg-gray-200 rounded-full overflow-hidden">
                    <div
                      className={`h-full bg-green-500 transition-all duration-1000 delay-1000 ${isPhilosophyVisible ? "w-full" : "w-0"
                        }`}
                    ></div>
                  </div>
                </div>
                <div className="text-center space-y-2 group">
                  <div
                    className={`text-2xl sm:text-3xl font-black text-green-500 transition-all duration-500 delay-800 ${isPhilosophyVisible ? "opacity-100 scale-100" : "opacity-0 scale-50"
                      } group-hover:scale-110`}
                  >
                    HTX
                  </div>
                  ...
                  <div className="w-full h-1 bg-gray-200 rounded-full overflow-hidden">
                    <div
                      className={`h-full bg-yellow-400 transition-all duration-1000 delay-1100 ${isPhilosophyVisible ? "w-full" : "w-0"
                        }`}
                    ></div>
                  </div>
                </div>
                <div className="text-center space-y-2 group">
                  <div
                    className={`text-2xl sm:text-3xl font-black text-black transition-all duration-500 delay-900 ${isPhilosophyVisible ? "opacity-100 scale-100" : "opacity-0 scale-50"
                      } group-hover:scale-110`}
                  >
                  ...
                  <div className="w-full h-1 bg-gray-200 rounded-full overflow-hidden">
                    <div
                      className={`h-full bg-red-500 transition-all duration-1000 delay-1200 ${isPhilosophyVisible ? "w-full" : "w-0"
                        }`}
                    ></div>
                  </div>
                </div>
        ...
        <div
          className={`absolute top-16 sm:top-32 left-0 w-0.5 sm:w-1 bg-green-500/40 transition-all duration-1000 delay-1000 ${isPhilosophyVisible ? "h-16 sm:h-32 opacity-100" : "h-0 opacity-0"
            }`}
        ></div>
        <div
          className={`absolute bottom-16 sm:bottom-32 right-0 w-0.5 sm:w-1 bg-black/20 transition-all duration-1000 delay-1100 ${isPhilosophyVisible ? "h-16 sm:h-32 opacity-100" : "h-0 opacity-0"
            }`}
        ></div>
      </section>
      ...
      <section id="merchandise" ref={merchRef} className="py-12 sm:py-24 bg-white relative overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none">
          <div
            className={`absolute top-32 right-16 w-40 h-40 bg-green-500/3 rounded-full transition-all duration-1000 ${isMerchVisible ? "opacity-100 scale-100" : "opacity-0 scale-50"
              }`}
          ></div>
          <div
            className={`absolute bottom-32 left-16 w-28 h-28 bg-red-500/3 rounded-full transition-all duration-1000 delay-400 ${isMerchVisible ? "opacity-100 scale-100" : "opacity-0 scale-50"
              }`}
          ></div>

          {/* Floating Mascots */}
          <div
            className={`absolute top-20 left-20 w-16 h-16 transition-all duration-1000 delay-600 ${isMerchVisible ? "opacity-30 scale-100 rotate-12" : "opacity-0 scale-50 rotate-0"
              }`}
          >
            <img src="/images/mascot-2.png" alt="CTZNS Mascot" className="w-full h-full object-contain" />
          </div>
          <div
            className={`absolute bottom-40 right-32 w-20 h-20 transition-all duration-1000 delay-800 ${isMerchVisible ? "opacity-20 scale-100 -rotate-12" : "opacity-0 scale-50 rotate-0"
              }`}
          >
            <img src="/images/mascot-1.png" alt="CTZNS Mascot" className="w-full h-full object-contain" />
          </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative text-center">
          <div className="space-y-8 sm:space-y-12">
            <div className="space-y-4 sm:space-y-6">
              <div
                className={`flex items-center justify-center space-x-3 transition-all duration-700 ${isMerchVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
                  }`}
              >
                <div className="w-8 sm:w-12 h-0.5 bg-black"></div>
                <span className="text-xs sm:text-sm font-light tracking-widest uppercase text-gray-600">
              ...
              <div
                className={`transition-all duration-700 delay-200 ${isMerchVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
                  }`}
              >
                <h2 className="text-3xl sm:text-4xl md:text-5xl font-black tracking-tighter text-black">
                  Wear Your Brand
                  <span className="block text-green-500 relative">
                    ...
                    {/* Animated underline */}
                    <div
                      className={`absolute bottom-0 left-1/2 transform -translate-x-1/2 h-1 bg-green-500/20 transition-all duration-1000 delay-700 ${isMerchVisible ? "w-full" : "w-0"
                        }`}
                    ></div>
                  </span>
                </h2>
              ...
              <div
                className={`w-16 h-1 bg-green-500 mx-auto mt-4 transition-all duration-1000 delay-700 ${isMerchVisible ? "opacity-100 scale-100" : "opacity-0 scale-50"
                  }`}
              ></div>

              <div
                className={`transition-all duration-700 delay-400 ${isMerchVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
                  }`}
              >
            ...
            {/* CTA Button */}
            <div
              className={`transition-all duration-700 delay-600 ${isMerchVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
                }`}
            >
              <Link href="/products">
                <Button
        ...
        {/* Animated side accents */}
        <div
          className={`absolute top-16 sm:top-32 left-0 w-0.5 sm:w-1 bg-green-500/40 transition-all duration-1000 delay-1000 ${isMerchVisible ? "h-16 sm:h-32 opacity-100" : "h-0 opacity-0"
            }`}
        ></div>
        <div
          className={`absolute bottom-16 sm:bottom-32 right-0 w-0.5 sm:w-1 bg-black/20 transition-all duration-1000 delay-1100 ${isMerchVisible ? "h-16 sm:h-32 opacity-100" : "h-0 opacity-0"
            }`}
        ></div>
      </section>
      ...
      <section id="work" ref={workRef} className="py-12 sm:py-24 bg-white relative overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none">
          <div
            className={`absolute top-20 left-10 w-32 h-32 bg-green-500/5 rounded-full transition-all duration-1000 ${isWorkVisible ? "opacity-100 scale-100" : "opacity-0 scale-50"
              }`}
          ></div>
          <div
            className={`absolute bottom-20 right-10 w-24 h-24 bg-yellow-400/5 rounded-full transition-all duration-1000 delay-300 ${isWorkVisible ? "opacity-100 scale-100" : "opacity-0 scale-50"
              }`}
          ></div>
          <div
            className={`absolute top-1/2 left-1/4 w-16 h-16 bg-red-500/5 rounded-full transition-all duration-1000 delay-500 ${isWorkVisible ? "opacity-100 scale-100" : "opacity-0 scale-50"
              }`}
          ></div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="space-y-8 sm:space-y-16">
            <div className="text-center space-y-4 sm:space-y-6">
              <div
                className={`flex items-center justify-center space-x-3 transition-all duration-700 ${isWorkVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
                  }`}
              >
                <div className="w-8 sm:w-12 h-0.5 bg-black"></div>
              ...
              <div
                className={`transition-all duration-700 delay-200 ${isWorkVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
                  }`}
              >
                <h2 className="text-3xl sm:text-4xl md:text-5xl font-black tracking-tighter text-black">
                  Latest
                  <span className="text-green-500 relative block">
                    ...
                    {/* Animated underline */}
                    <div
                      className={`absolute bottom-0 left-0 h-1 bg-green-500/20 transition-all duration-1000 delay-700 ${isWorkVisible ? "w-full" : "w-0"
                        }`}
                    ></div>
                  </span>
                </h2>
              ...
              <div
                className={`w-16 h-1 bg-green-500 mx-auto mt-4 transition-all duration-1000 delay-700 ${isWorkVisible ? "opacity-100 scale-100" : "opacity-0 scale-50"
                  }`}
              ></div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
              {[
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className={`group cursor-pointer transition-all duration-700 delay-${index * 200} ${isWorkVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-12"
                    }`}
                >
        ...
        {/* Animated side accents */}
        <div
          className={`absolute top-16 sm:top-32 left-0 w-0.5 sm:w-1 bg-green-500/40 transition-all duration-1000 delay-1000 ${isWorkVisible ? "h-16 sm:h-32 opacity-100" : "h-0 opacity-0"
            }`}
        ></div>
        <div
          className={`absolute bottom-16 sm:bottom-32 right-0 w-0.5 sm:w-1 bg-black/20 transition-all duration-1000 delay-1100 ${isWorkVisible ? "h-16 sm:h-32 opacity-100" : "h-0 opacity-0"
            }`}
        ></div>
      </section>
          ...
          <div className="space-y-8 sm:space-y-16">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16">
              ...
              <div className="space-y-6">
                ...
                <Link href="https://www.youtube.com/watch?v=dQw4w9WgXcQ" className="block">
